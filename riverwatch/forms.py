...
def submission_details(request):
    ...
    if(request.method == 'POST'):
        ...
        new_entry = riverwatch.models.Image()
        ...
        return HttpResponseRedirect(reverse('riverwatch.views.contact'))
